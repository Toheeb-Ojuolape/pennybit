...
import { fundWalletFields, FundWalletSchema } from "../schema/wallet";
            ...
            <button
              ...
              className={`text-white ${
                valuesRef?.current === null || valuesRef?.current?.values.message === "" || valuesRef?.current?.values.description === ""
                  ...
                  : "hover:bg-orange hover:text-white bg-orange  border-2 border-orange "
          ...
          {isWithdraw && (
            <Popup
              trigger={
                ...
                >
                  Proceed to Send <i className="fa fa-solid fa-arrow-right ml-2"></i>
                </button>
              }
