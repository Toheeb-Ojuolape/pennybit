      ...
      <div>
        ...
        <div className="w-full">
          ...
          <Link to="/wallet">
            <div
              className={`flex items-center text-black text-lg mb-7 font-semibold px-5 cursor-pointer py-3  ${
                location.pathname === "/wallet" && "text-center rounded-lg !text-white flex-purple bg-orange"
              }`}
            >
          ...
          <Link to="/exchange">
            <div
              className={`flex items-center text-black text-lg mb-7 font-semibold px-5 cursor-pointer py-3  ${
                location.pathname === "/exchange" && "text-center rounded-lg !text-white flex-purple bg-orange"
              }`}
            >
          ...
          <Link to="/learn">
            <div
              className={`flex items-center text-black text-lg mb-7 font-semibold px-5 cursor-pointer py-3  ${
                location.pathname === "/learn" && "text-center rounded-lg !text-white flex-purple bg-orange"
              }`}
            >
          ...
          <Link to="/play">
            <div
              className={`flex items-center text-black text-lg mb-7 font-semibold px-5 cursor-pointer py-3  ${
                location.pathname === "/play" && "text-black text-center rounded-lg !text-white flex-purple bg-orange"
              }`}
            >
          ...
          <Link to="/account">
            <div
              className={`flex items-center text-black text-lg mb-7 font-semibold px-5 cursor-pointer py-3  ${
                location.pathname === "/account" && "text-center rounded-lg !text-white flex-purple bg-orange"
              }`}
            >
